        ...
        <table width="100%">
            ...
            <volist name="list" id="vo">
                <tr>
                    ...
                    <td align="center">
                        <a href="{:url('article/edit',['id'=>$vo['id']])}" class="layui-btn layui-btn-small" style="margin-bottom:2px;">修改</a>
                        <a href="{:url('article/delete',['id'=>$vo['id']])}" class="layui-btn layui-btn-small layui-btn-danger" style="margin-bottom:2px;">删除</a> 
                    </td>
                </tr>
            </volist>
        </table>
